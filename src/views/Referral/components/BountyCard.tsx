...
const BountyCard = () => {
  ...
  const referralLinkToDisplay = anpanBountyToDisplay
        ...
        <CardBody>
          ...
          <Flex alignItems="center" justifyContent="space-between">
            <Flex flexDirection="column" mr="12px">
                  ...
                  <Heading fontSize="20px" display={referralLinkToDisplay.toString().slice(0, 5) + '...'} />
                  <CopyHelper toCopy={referralLinkToDisplay} />
